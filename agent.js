...
(function() {
    ...
    launcher.innerHTML =
        '<span class="agent-face" aria-hidden="true">' +
            '<img src="images/ai-avatar.svg?v=4" alt="" class="agent-face-img">' +
    ...
    panel.innerHTML =
        '<div class="agent-head">' +
            '<span class="agent-face agent-face-lg" aria-hidden="true">' +
                '<span class="agent-svg-slot"><img src="images/ai-avatar.svg?v=4" alt="" class="agent-face-img" id="agentAvatar"></span>' +
                '<span class="agent-online"></span>' +
            '</span>' +
    ...
    fetch('images/ai-avatar.svg?v=4').then(function(r) { return r.ok ? r.text() : null; }).then(function(text) {
        if (!text) return;
